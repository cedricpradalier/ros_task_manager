...
For a quick start, it is recommanded to look at the [turtlesim application](src/task_manager_turtlesim) sample, and in particular the [mission definition](src/task_manager_turtlesim/missions) in python.
